...
const Register = () => {
    ...
    return (
        <div className='md:flex gap-16 justify-center items-center md:p-10 bg-base-300 rounded-lg my-10'>
            <Lottie className='md:w-1/4' animationData={registerAnimation} loop={true}  ></Lottie>
